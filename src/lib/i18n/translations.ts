    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Harbour.Space University, Toulouse BS, Digitalhub.edu.ge ინსტრუქტორი. Performance Marketing-ის საინფორმაციო ბიულეტენი 1,800+ გამომწერით.',
        },
      ],
    },
    ...
    speaking: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'ფაკულტეტის წევრი, რომელიც ასწავლის ციფრული მარკეტინგის სამაგისტრო პროგრამაზე. მოდულები აკვიზიციაზე, ანალიტიკასა და ზრდაზე.',
        },
        {
          name: 'Performance Marketing Insights',
          date: 'მიმდინარე',
          topic: 'საინფორმაციო ბიულეტენი',
          description: 'ყოველკვირეული საინფორმაციო ბიულეტენი, რომელიც მოიცავს performance marketing-ს, AI-ს მარკეტინგში და ზრდის სტრატეგიებს. 1,800+ გამომწერი.',
        },
      ],
    },
