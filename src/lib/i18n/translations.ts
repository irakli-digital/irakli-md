export const translations = {
  ...
  ka: {
    ...
    amiStart: {
      ...
      subtitle: 'გთხოვთ, პირველ სესიამდე შეასრულოთ ქვემოთ მოცემული ყველა დავალება. თუ რაიმე შეფერხება შეგექმნებათ, შეგიძლიათ ჰკითხოთ კლოდს ან მოიტანოთ თქვენი კითხვები და ერთად მოვაგვარებთ.',
